 ...
 */
export declare const apiDocsPath: ((
 ...
 * @returns {string} route path
 */
export declare const apiOpenapiPath: ((
  options?: {format?: OptionalRouteParameter} & RouteOptions
) => string) & RouteHelperExtras;
 ...
 * @returns {string} route path
 */
export declare const apiV1ItemPath: ((
 ...
 * @returns {string} route path
 */
export declare const apiV1ItemsPath: ((
  options?: {format?: OptionalRouteParameter} & RouteOptions
) => string) & RouteHelperExtras;
 ...
 * @returns {string} route path
 */
export declare const localePath: ((
  options?: {format?: OptionalRouteParameter} & RouteOptions
) => string) & RouteHelperExtras;
